...
import { CheckCircle, ExternalLink, MessageSquare, Ticket, XCircle } from "lucide-react"

export default function AutomaticResponsePage() {
  const { analysis, result, voiceError, completionSeconds } = useKiosk()

  if (analysis?.next_action !== "DECLINE" && (!result?.ticket || !result.response)) return null
